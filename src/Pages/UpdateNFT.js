...
const UpdateNFT = () => {
  ...
  const handleUpdate = async () => {
    axios.post(http + "api/article/change/price/" + id, {price:createData.price })
        .then(res =>{
      ...
      <div className="create-container">
        ...
        <section className="mt-30 mt-sm-20">
          ...
          <div className="mt-25 mt-sm-10">
              ...
              <Switch defaultChecked={createData.isFree} onChange={handleSetMintTyoe} disabled/>
